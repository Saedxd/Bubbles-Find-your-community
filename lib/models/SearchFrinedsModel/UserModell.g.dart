...
Serializer<UserModell> _$userModellSerializer = new _$UserModellSerializer();

class _$UserModellSerializer implements StructuredSerializer<UserModell> {
  @override
  final Iterable<Type> types = const [UserModell, _$UserModell];
  @override
  final String wireName = 'UserModell';

  @override
  Iterable<Object?> serialize(Serializers serializers, UserModell object,
  ...
  @override
  UserModell deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new UserModellBuilder();
...
class _$UserModell extends UserModell {
  @override
  final String? email;
  @override
  final int? id;
  ...
  factory _$UserModell([void Function(UserModellBuilder)? updates]) =>
      (new UserModellBuilder()..update(updates))._build();
  ...
  @override
  UserModell rebuild(void Function(UserModellBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  UserModellBuilder toBuilder() => new UserModellBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UserModell &&
        email == other.email &&
        id == other.id &&
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, email.hashCode), id.hashCode), is_creator.hashCode), email_verified_at.hashCode), created_at.hashCode), updated_at.hashCode), first_name.hashCode), last_name.hashCode), background_color.hashCode), bio.hashCode), birth_date.hashCode), alias.hashCode), fcm_token.hashCode), lattitude.hashCode), langtitude.hashCode), avatar.hashCode), avatar_social.hashCode), serial.hashCode),
                                                                                image1.hashCode),
                                                                            image2.hashCode),
                                                                        login_at.hashCode),
                                                                    is_notify.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'UserModell')
          ..add('email', email)
          ..add('id', id)
...
class UserModellBuilder implements Builder<UserModell, UserModellBuilder> {
  _$UserModell? _$v;
  ...
  @override
  void replace(UserModell other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$UserModell;
  }

  @override
  void update(void Function(UserModellBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  UserModell build() => _build();

  _$UserModell _build() {
    _$UserModell _$result;
    try {
      _$result = _$v ??
          new _$UserModell._(
              email: email,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'UserModell', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
