...
class _$GetFriendsModel extends GetFriendsModel {
  ...
  _$GetFriendsModel._({this.msg, this.StatusCode, this.friends}) : super._();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetFriendsModel')
          ..add('msg', msg)
    ...
    try {
      _$result = _$v ??
          new _$GetFriendsModel._(
              msg: msg, StatusCode: StatusCode, friends: _friends?.build());
    } catch (_) {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GetFriendsModel', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
