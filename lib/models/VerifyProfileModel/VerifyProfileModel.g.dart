...
class _$VerifyProfileModel extends VerifyProfileModel {
  ...
  _$VerifyProfileModel._({this.msg, this.statuscode}) : super._();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('VerifyProfileModel')
          ..add('msg', msg)
...
class VerifyProfileModelBuilder
  ...
  _$VerifyProfileModel _build() {
    final _$result =
        _$v ?? new _$VerifyProfileModel._(msg: msg, statuscode: statuscode);
    replace(_$result);
    return _$result;
  }
}
