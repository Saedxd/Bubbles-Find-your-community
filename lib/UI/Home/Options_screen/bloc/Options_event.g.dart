...
class _$ChangeDone1 extends ChangeDone1 {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ChangeDone1')
...
class _$ChangeDone2 extends ChangeDone2 {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ChangeDone2')
...
class _$CreateBubble extends CreateBubble {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('CreateBubble')
          ..add('lng', lng)
          ..add('lat', lat)
          ..add('raduis', raduis)
          ..add('Dates', Dates)
...
class _$ChangeDone3 extends ChangeDone3 {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ChangeDone3')
