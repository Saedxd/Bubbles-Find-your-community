...
import 'package:bubbles/UI/Home/Home_Screen/pages/SeeAll_Screen/Events_Screen.dart';
import 'package:bubbles/UI/Home/Options_screen/data/data.dart';
import 'package:bubbles/UI/Home/Home_Screen/pages/CreateBubble_Screen/Options_screen.dart';
                     ...
                     for(int i=0;i<state.locationn!.length;i++) {
                       print(i);
                         ...
                         new_long = state.locationn![i].lng! + coef / cos(state
                             .locationn![i]
                             .lat! * 0.018);
                         print(state.locationn![i].lng!);
                         print(state.locationn![i].lat!);
                         print(User_lat);
                         print(User_long);
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Container(
                                                                                          ...
                                                                                          decoration: BoxDecoration(
                                                                                            color: Colors.transparent,
                                                                                            boxShadow : [BoxShadow(
                                                                                                color: Color(state.FilteredBubbleList![index].Color!).withOpacity(0.8),
                                                                                                offset: Offset(0,0),
                                                                                        ...
                                                                                        child: Column(
                                                                                          children: [
                                                                                            ...
                                                                                            const SizedBox(height: 8,),
                                                                                             Container(
                                                                                               width:w/1.5,
                                                                                               child: Text(state.FilteredBubbleList![index].Category.toString(), textAlign: TextAlign.left, style: TextStyle(
                                                                                                  color: Color.fromRGBO(255, 255, 255, 1),
                                                                                                  fontFamily: 'Red Hat Text',
                                                  ...
                                                  children: [
                                                    ...
                                                    InkWell(
                                                      onTap: () async {
                                                        ...
                                                        // }else{
                                                        // await getCenter();
                                                        Dataa.lng = state.Bubble_lng;
                                                        Dataa.lat =state.Bubble_lat;
