...
class _Options_screenState extends State<Options_screen> {
                        ...
                        child: IconButton(
                          ...
                          onPressed:(){}
                            ...
                            Container(
                              ...
                              child: Center(
                                  child:
                                  Text('Adding the name of the location, venue, establichment etc can help your audience reach your bubble.', textAlign: TextAlign.left, style: TextStyle(
                                      color: Color.fromRGBO(255, 255, 255, 1),
                                      fontFamily: 'Red Hat Text',
                                      fontSize: 13,
                                      letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                  ...
                  InkWell(
                    onTap: () {
                      try {
                        ...
                        _HomeBloc.add(AddStartandEndTime((b) =>
  ...
  Future<void> FreindDilog() {
    ...
    return showModalBottomSheet<void>(
                                      ...
                                      Container(
                                          ...
                                          child: Form(
                                            ...
                                            child: TextFormField(
                                              ...
                                              cursorHeight: 20,
                                              onChanged: (Keyword){
                                                _HomeBloc.add(SearchFreinds((b) => b
                                                  ..Keyword = Keyword
                                                ));
                                              },
                                              decoration: InputDecoration(
      ...
      //   _HomeBloc.add(SearchFreinds((b) => b..Keyword=""));
      _HomeBloc.add(ChangeDone3((b) => b..ChangeDone33 = true));
    }
...
//                       _HomeBloc.add(ChangeDone3((b) => b..ChangeDone33 = false));
//                       print("HIM HEREEE");
//                       OrganizersId.clear();
...
//                   _HomeBloc.add(ChangeDone2((b) => b..DoneColor2 = false));
//
//                   print("im here");
//
//                   return false;
...
//                   STartTimeString = "";
//                   EndTimeString = "";
//                   _HomeBloc.add(ChangeDone1((b) => b..DoneColor1 = false));
//                   return false;
//                 }
