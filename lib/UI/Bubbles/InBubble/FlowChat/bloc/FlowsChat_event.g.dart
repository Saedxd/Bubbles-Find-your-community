...
class _$SendMessage extends SendMessage {
  ...
  bool operator ==(Object other) {
    ...
    return other is SendMessage &&
        ...
        FlowMessage_Id == other.FlowMessage_Id &&
        type == other.type &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'SendMessage')
          ...
          ..add('message', message)
          ..add('FlowMessage_Id', FlowMessage_Id)
          ..add('type', type)
...
class SendMessageBuilder implements Builder<SendMessage, SendMessageBuilder> {
  ...
  int? _FlowMessage_Id;
  int? get FlowMessage_Id => _$this._FlowMessage_Id;
  set FlowMessage_Id(int? FlowMessage_Id) =>
      _$this._FlowMessage_Id = FlowMessage_Id;
  ...
  SendMessageBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _message = $v.message;
      _FlowMessage_Id = $v.FlowMessage_Id;
      _type = $v.type;
...
class _$AddModel extends AddModel {
  @override
  final GroupChatFlowsMessage? message;
...
class AddModelBuilder implements Builder<AddModel, AddModelBuilder> {
  ...
  GroupChatFlowsMessage? _message;
  GroupChatFlowsMessage? get message => _$this._message;
  set message(GroupChatFlowsMessage? message) => _$this._message = message;
...
class _$GetOldMessages extends GetOldMessages {
  ...
  _$GetOldMessages._({this.message_id}) : super._();
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GetOldMessages && message_id == other.message_id;
  }

  @override
  int get hashCode {
    return $jf($jc(0, message_id.hashCode));
  }
...
class GetOldMessagesBuilder
  ...
  _$GetOldMessages _build() {
    final _$result = _$v ?? new _$GetOldMessages._(message_id: message_id);
    replace(_$result);
    return _$result;
  }
}
