...
class Sprints extends StatefulWidget {
  Sprints({Key? key, required this.receiver_id, required this.my_ID})
      : super(key: key);
  int receiver_id = 0;
  int my_ID;
...
class _SprintsState extends State<Sprints> {
  ...
  void setHisMessage(String message) {
    ...
    _Sprints_Bloc.add(AddModel((b) => b..message = messageModel));
  ...
  Widget ReplyWidgett(SprintsState state) {
    TextTheme _textthem = Theme.of(context).textTheme;
    ColorScheme COLOR = Theme.of(context).colorScheme;
    var h = MediaQuery.of(context).size.height;
    var w = MediaQuery.of(context).size.width;
