...
class _$PostLOgin extends PostLOgin {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PostLOgin')
          ..add('Email', Email)
...
class _$LoginSocial extends LoginSocial {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('LoginSocial')
          ..add('fcmToken', fcmToken)
          ..add('Token', Token))
        .toString();
  }
...
class _$LoginGoogle extends LoginGoogle {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('LoginGoogle')
          ..add('Email', Email)
          ..add('name', name)
          ..add('fcmToken', fcmToken)
          ..add('avatar', avatar))
...
class _$SetPermission extends SetPermission {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('SetPermission')
